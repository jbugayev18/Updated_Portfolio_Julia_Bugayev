    ...
    <main className="all-projects">
      ...
      <div className="project">
        ...
        <a href="https://github.com/jbugayev18/TutorApp-">
          <FontAwesomeIcon icon={faGithubAlt} className="project-icon" /> GitHub
          Client
        </a>
        ...
        <p>
          ...
          tutor catered to selected zipcodes provided from the application. The
          application also provides school subject material that the user is
      ...
      <div className="project">
        ...
        <p>
          {" "}
          "DonationHub" allows users to locate donation organization near them,
          browse items that the donation center needs, and donate as they please
          accordingly. Users are also able to add donation sites for
          organizations that may not be as internet accessible.
        </p>
        ...
        <p>
          ...
          for performant box intersection query, Third Party APIs (Google Maps,
          Google Places)
        </p>
      </div>
    </main>
